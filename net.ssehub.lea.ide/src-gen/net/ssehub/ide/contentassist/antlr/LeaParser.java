...
public class LeaParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LeaGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGenericTypeAccess().getAlternatives(), "rule__GenericType__Alternatives");
			...
			builder.put(grammarAccess.getElementDeclarationAccess().getGroup(), "rule__ElementDeclaration__Group__0");
			...
			builder.put(grammarAccess.getAnalysisDefinitionAccess().getElementDeclarationsAssignment_1_0(), "rule__AnalysisDefinition__ElementDeclarationsAssignment_1_0");
			builder.put(grammarAccess.getAnalysisDefinitionAccess().getChangeIdentifierAssignmentsAssignment_1_1(), "rule__AnalysisDefinition__ChangeIdentifierAssignmentsAssignment_1_1");
			...
			builder.put(grammarAccess.getElementDeclarationAccess().getGenericTypAssignment_0(), "rule__ElementDeclaration__GenericTypAssignment_0");
			builder.put(grammarAccess.getElementDeclarationAccess().getParameterTypeAssignment_2(), "rule__ElementDeclaration__ParameterTypeAssignment_2");
			builder.put(grammarAccess.getElementDeclarationAccess().getSetAssignment_4(), "rule__ElementDeclaration__SetAssignment_4");
			builder.put(grammarAccess.getElementDeclarationAccess().getNameAssignment_5(), "rule__ElementDeclaration__NameAssignment_5");
			builder.put(grammarAccess.getElementDeclarationAccess().getInitializationAssignment_6(), "rule__ElementDeclaration__InitializationAssignment_6");
