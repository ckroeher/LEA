 ...
 * {@link ElementType#FRAGMENT_PARAMETER_TYPE} by the {@link ExternalLanguageElementCreator}.
 * 
...
public class FragmentParameterTypeCreationTests extends AbstractLanguageElementCreationTest {
     ...
     */
//CHECKSTYLE:OFF
    public FragmentParameterTypeCreationTests(Class<?> testInputClass, LanguageElementException expectedException,
