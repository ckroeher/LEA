 ...
 * {@link ElementType#RESULT_PARAMETER_TYPE}.
 * 
...
@Retention(RUNTIME)
@Target(TYPE)
public @interface ResultParameterType {

    /**
     * Returns the (symbolic) name of this {@link ElementType#RESULT_PARAMETER_TYPE}. If this name is defined, it is 
     * proposed as language element instead of using the name of the annotated class.
     * 
     * @return the (symbolic) name of this {@link ElementType#RESULT_PARAMETER_TYPE}; the default valued is an 
     *         <i>empty</i> string
     */
    public String name() default "";
    
    /**
     * Returns the (symbolic) name of the optional parameter type of this {@link ElementType#RESULT_PARAMETER_TYPE},
     ...
     * 
     * @return the (symbolic) name of the optional parameter type of this {@link ElementType#RESULT_PARAMETER_TYPE},
