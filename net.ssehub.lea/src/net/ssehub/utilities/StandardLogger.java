...
/**
 * This class is used to print different types of information to the console via {@link System#out}.
 * 
...
public class StandardLogger extends AbstractLogger {
    ...
    /**
     * Constructs a new {@link StandardLogger} instance with a default log level of {@link LogLevel#STANDARD}.
     */
    protected StandardLogger() {
        super("StandardLogger");
    }
